...
function chooseColor(x) {
    if (x > 30) return "#800000";
    else if (x > 20) return "#FF0000";
    else if (x > 15) return "#FF6600";
    else if (x > 10) return "#FFFF00";
    else if (x > 5) return "#99CC00";
    else if (x > -10) return "#00FF00";
}
